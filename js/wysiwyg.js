...
jQuery().ready(function() {
    jQuery('textarea.tinymce').tinymce({
        ...
        // Theme options
        theme_advanced_buttons1 : "bold,italic,underline,strikethrough,|,justifyleft,justifycenter,justifyright,justifyfull,outdent,indent,blockquote,fontsizeselect",
        theme_advanced_buttons2 : "pastetext,pasteword,|,bullist,numlist,|,undo,redo,|,link,unlink,code,|,preview,|,forecolor,backcolor,removeformat,|,fullscreen",
